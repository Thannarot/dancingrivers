"""
Django settings for Dancing River project.
"""
...
SECRET_KEY = '!k#z7irhf-bg^35(covson&@l8c^0jczmnjr1olc^%*htky0a='
...
WSGI_APPLICATION = 'dancingriver.wsgi.application'
...
EE_IMAGE_RIVER_COLLECTION = 'users/seiasia/river_boundary_irra'
EE_USE_CELERY = False
